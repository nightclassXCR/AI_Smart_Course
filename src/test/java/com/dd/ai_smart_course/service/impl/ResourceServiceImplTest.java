...
//        // Given
//        Long resourceId = 1L;
//        when(resourceMapper.selectById(Math.toIntExact(resourceId))).thenReturn(testResource);
//
//        // When
//        Resource foundResource = resourceService.findById(Math.toIntExact(resourceId));
//
//        // Then
...
//        verify(resourceMapper, times(1)).selectById(Math.toIntExact(resourceId));
//    }
//
//    @Test
...
//        when(resourceMapper.selectById(Math.toIntExact(resourceId))).thenReturn(null);
//
//        // When
//        Resource foundResource = resourceService.findById(Math.toIntExact(resourceId));
//
...
//
//        // When
//        resourceService.delete(Math.toIntExact(resourceId));
//
//        // Then
...
//        anotherResource.setOwnerId(201);
