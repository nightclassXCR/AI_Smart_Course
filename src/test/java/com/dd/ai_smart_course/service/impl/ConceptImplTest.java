...
//                createConcept(1, 100, "Java变量", "变量概念"),
//                createConcept(2, 100, "数据类型", "数据类型概念"),
//                createConcept(3, 100, "运算符", "运算符概念")
//        );
//
//        testQuestionList = Arrays.asList(
//                createQuestion(1, "什么是变量？", "概念题"),
//                createQuestion(2, "如何声明变量？", "操作题")
//        );
//    }
//
//    /**
...
//        assertEquals(1, event.getTargetId());
...
//
//    // 辅助方法：创建 Concept 对象
//    private Concept createConcept(int id, int chapterId, String name, String description) {
...
//
//    // 辅助方法：创建 Question 对象
//    private Question createQuestion(int id, String content, String type) {
