...
public interface QAMapper {
    ...
    // 更新QA记录信息
    @Update("UPDATE qa_records SET user_id = #{userId}, course_id = #{courseId}, concept_id = #{conceptId}, responder_id = #{responderId}, question_text = #{questionText}," +
